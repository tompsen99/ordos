class MixingUI {
    ...
    bindGroupEvents() {
        ...
        if (!container) return;  // 添加检查，确保容器存在
    ...
    calculateGrade(length, fineness) {
        ...
        if (fineness < 15) {
            ...
            if (length > 28 && length <= 32) return 'G3';
            if (length > 26 && length <= 28) return 'G4';
        ...
        // J系列
        if (length > 34.5) {
            if (fineness >= 15 && fineness < 15.2) return 'J0';
            if (fineness >= 15.2 && fineness < 15.6) return 'J1';
            if (fineness >= 15.6 && fineness < 16.3) return 'J2';
        ...
        if (length > 32.0 && length <= 33.5 && fineness >= 15.6 && fineness < 15.8) return 'A02';
        if (length > 32.0 && length <= 33.5 && fineness >= 15.8 && fineness < 16.0) return 'A03';
        if (length > 31.5 && length <= 33.0 && fineness >= 15.8 && fineness < 16.0) return 'A04';
        if (length > 31.5 && length <= 33.0 && fineness >= 16.0 && fineness < 16.3) return 'A05';
        if (length > 31.5 && length <= 33.0 && fineness >= 16.3 && fineness < 16.5) return 'A06';
        if (length > 30.0 && length <= 31.5 && fineness >= 16.5 && fineness < 16.8) return 'A07';
        if (length > 30.0 && length <= 33.0 && fineness >= 16.8 && fineness < 17.6) return 'A08';

        // B系列
        if (length > 30.0 && length <= 31.5 && fineness >= 15.8 && fineness < 16.0) return 'B1';
        if (length > 28.0 && length <= 30.0 && fineness >= 15.8 && fineness < 16.0) return 'B2';
        if (length > 26.0 && length <= 28.0 && fineness >= 15.8 && fineness < 16.0) return 'B3';
        if (length > 26.0 && length <= 28.0 && fineness >= 15.8 && fineness < 16.0) return 'B4';
        if (length > 26.0 && length <= 28.0 && fineness >= 16.0 && fineness < 16.5) return 'B5';
        if (length > 33.0 && fineness >= 16.6 && fineness < 17.2) return 'B6';
        if (length > 28.0 && length <= 30.0 && fineness >= 16.5 && fineness < 16.8) return 'B7';

        // C系列
        if (length > 34.5 && fineness >= 16.5 && fineness < 16.6) return 'C1';
        if (length > 33.0 && fineness >= 17.2) return 'C2';
        if (length > 34.0 && length <= 34.5 && fineness >= 15.0 && fineness < 15.2) return 'C3';
        if (length > 34.0 && length <= 34.5 && fineness >= 15.6 && fineness < 15.8) return 'C4';
        if (length > 34.0 && length <= 34.5 && fineness >= 15.8 && fineness < 16.3) return 'C5';
        if (length > 34.0 && length <= 34.5 && fineness >= 16.3 && fineness < 16.5) return 'C6';
        if (length > 33.5 && length <= 34.0 && fineness >= 15.8 && fineness < 16.0) return 'C7';
        if (length > 33.0 && length <= 34.0 && fineness >= 16.0 && fineness < 16.3) return 'C8';
        if (length > 33.0 && length <= 33.5 && fineness >= 15.8 && fineness < 16.0) return 'C9';
        if (length > 32.0 && length <= 33.5 && fineness >= 16.5 && fineness < 16.6) return 'C10';
        if (length > 30.0 && length <= 32.0 && fineness < 15.2) return 'C11';
        if (length > 32.0 && length <= 34.0 && fineness >= 15.0 && fineness < 15.2) return 'C12';
        if (length > 31.5 && length <= 33.0 && fineness >= 16.5) return 'C13';
        if (length > 30.0 && length <= 32.0 && fineness >= 15.2 && fineness < 15.5) return 'C14';
        if (length > 30.0 && length <= 32.0 && fineness >= 15.5 && fineness < 16.0) return 'C15';
        if (length > 30.0 && length <= 31.5 && fineness >= 16.0 && fineness < 16.5) return 'C16';
        if (length > 30.0 && length <= 33.0 && fineness >= 17.6) return 'C17';
        if (length > 28.0 && length <= 30.0 && fineness >= 16.8) return 'C18';
        if (length > 28.0 && length <= 30.0 && fineness >= 15.2 && fineness < 15.8) return 'C19';
        if (length > 26.0 && length <= 28.0 && fineness >= 15.2 && fineness < 15.8) return 'C20';
        if (length > 26.0 && length <= 28.0 && fineness >= 16.5) return 'C21';
        if (length > 24.0 && length <= 26.0 && fineness < 14.0) return 'C22';
        if (length > 24.0 && length <= 26.0 && fineness >= 14.0 && fineness < 14.5) return 'C23';
        if (length > 24.0 && length <= 26.0 && fineness >= 14.5 && fineness < 15.0) return 'C24';
        if (length > 24.0 && length <= 26.0 && fineness >= 15.0 && fineness < 15.2) return 'C25';
        if (length > 24.0 && length <= 26.0 && fineness >= 15.2 && fineness < 16.0) return 'C26';
        if (length > 24.0 && length <= 26.0 && fineness >= 16.0) return 'C27';
        if (length > 22.0 && length <= 24.0) return 'C28';
        if (length <= 20.0) return 'C29';
        if (length > 30.0 && fineness < 16.5) return 'C31';
        if (length > 30.0 && fineness >= 16.5) return 'C32';
        if (length <= 30.0 && fineness >= 16.5) return 'C33';
        if (length <= 30.0) return 'C34';
        if (length <= 30.0) return 'C35';
        if (length > 30.0 && length <= 32.0 && fineness >= 17.5) return 'C36';
        if (length > 32.0) return 'C37';
        if (fineness < 17.0) return 'C38';
        if (fineness >= 17.0) return 'C39';
        if (length <= 30.0) return 'C40';
        if (length > 30.0) return 'C41';

        return '未分级';  // 如果不符合任何等级条件
    }
